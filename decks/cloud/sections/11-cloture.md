...
<div class="relative z-10 h-full flex items-end pb-16 pl-4 gap-16">
  <div class="flex-1">
    <div class="text-[#457b9d] text-sm font-bold uppercase tracking-widest mb-4">Cloud · GCP · Formation Simplon · 2026</div>
...
<!--
- Slide finale du template — QR code LinkedIn visible pendant les questions
- CTA assumé : retrouver Maxime sur LinkedIn pour poursuivre la conversation
-->
